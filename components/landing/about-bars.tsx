...
export function AboutBars() {
  return (
    <section id="bars" className="bg-background" style={{ backgroundColor: '#eae6df' }}>
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-stretch lg:grid-cols-2">
        ...
        <AnimatedFadeUp className="flex flex-col justify-center bg-secondary px-5 py-0 md:px-12" style={{ paddingBottom: '6px', gap: '0px' }}>
