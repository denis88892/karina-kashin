          ...
          <div className="flex flex-1 flex-col justify-center px-8 py-32 lg:px-16 lg:py-32 max-w-[55%]">
            ...
            <AnimatedFadeUp>
              <p
                ...
                style={{ color: '#C9A063', fontSize: '22px' }}
              >
            ...
            <AnimatedFadeUp delay={0.1}>
              <h1
                ...
                style={{ color: '#2A1F17', fontSize: '104px', fontWeight: 400, fontFamily: '"Playfair Display", sans-serif' }}
              >
                ЧТО ЕЩЁ<br />ВОЗМОЖНО?
              </h1>
              {/* Gold divider */}
            ...
            <AnimatedFadeUp delay={0.2}>
              <div className="mt-8 space-y-1.5" style={{ lineHeight: '1.3em', paddingLeft: '0px' }}>
                {['Уберите шум.', 'Услышьте себя.', 'Создайте другую реальность.'].map((line) => (
                  <p
                    key={line}
                    className="font-light leading-relaxed"
                    style={{ color: '#2A1F17', fontSize: '25px' }}
                  >
                    {line}
                  </p>
                ))}
            ...
            {[
              ...
              >
                <span
                  ...
                  style={{ color: '#C9A063', fontFamily: '"Manrope", sans-serif', fontSize: '34px' }}
                >
                  {stat.number}
                </span>
                <span
